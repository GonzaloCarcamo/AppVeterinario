...
class PetHistoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pet_history" do
    assert_difference('PetHistory.count') do
      post pet_histories_url, params: { pet_history: { altura: @pet_history.altura, descripcion: @pet_history.descripcion, peso: @pet_history.peso, pet_id: @pet_history.pet_id } }
    end
  ...
  test "should update pet_history" do
    patch pet_history_url(@pet_history), params: { pet_history: { altura: @pet_history.altura, descripcion: @pet_history.descripcion, peso: @pet_history.peso, pet_id: @pet_history.pet_id } }
